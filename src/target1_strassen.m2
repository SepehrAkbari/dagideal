...
adj = M -> matrix {
    { det submatrix(M,{1,2},{1,2}), -det submatrix(M,{1,2},{0,2}),  det submatrix(M,{1,2},{0,1}) },
    {-det submatrix(M,{0,2},{1,2}),  det submatrix(M,{0,2},{0,2}), -det submatrix(M,{0,2},{0,1}) },
    { det submatrix(M,{0,1},{1,2}), -det submatrix(M,{0,1},{0,2}),  det submatrix(M,{0,1},{0,1}) }
}
